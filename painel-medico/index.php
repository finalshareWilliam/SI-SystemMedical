		...
		<div class="row">
			<div class="col-md-3 col-sm-12 mb-4">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link <?php echo @$item7ativo ?>" id="v-pills-messages-tab"  href="index.php?acao=<?php echo $item7 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="far fa-user mr-1"></i>Pacientes</a>
					...
					<div class="tab-pane fade show active"  role="tabpanel">
						<?php if(@$_GET['acao'] == $item1){
							...
							include_once($item3.".php");
								...
								$pag = 'externa';
								include_once("../painel-atend/".$item4.".php"); 
						}elseif(@$_GET['acao'] == $item7){
							$pag = 'externa';
