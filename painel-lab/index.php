...
@session_start();
if(!isset($_SESSION['nome_usuario']) || $_SESSION['nivel_usuario'] != 'Laboratorio'){
...
<html lang="pt-br">
<head>
	<title>Painel Laboratorio</title>
		...
		<div class="col-md-12">
			...
			<li class="float-right nav-item dropdown">
				<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					Laboratorio - <?php echo $_SESSION['nome_usuario']; ?>
				</a>
		...
		<div class="row">
			<div class="col-md-3 col-sm-12 mb-4">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link <?php echo @$item2ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item2 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="true"><i class="far fa-user mr-1"></i>Cadastro Exames</a>
