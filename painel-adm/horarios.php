...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Novo Horário</a>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php if(@$_GET['funcao'] == 'editar'){
					...
					$res = $pdo->query("select * from horarios where id = '$id_reg'");
					$dados = $res->fetchAll(PDO::FETCH_ASSOC);
					$nome = $dados[0]['horario'];



					echo 'Edição de Horário';
				}else{
					$nome_botao = 'Salvar';
					echo 'Cadastro de Horário';
				} ?>
			</h5>
		...
		<div class="modal-body">
			...
			<form method="post">
				...
				<div class="form-group">
					...
					<input type="time" class="form-control" id="nome" placeholder="Insira o Horário" name="nome" value="<?php echo @$nome ?>" required>
					</div>
