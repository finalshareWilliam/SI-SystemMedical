		...
		<div class="row">
			<div class="col-md-3 col-sm-12 mb-4">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link <?php echo @$item8ativo ?>" id="v-pills-messages-tab"  href="index.php?acao=<?php echo $item8 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="far fa-user mr-1"></i>Cadastro Pacientes</a>

					<a class="nav-link <?php echo @$item12ativo ?>" id="v-pills-messages-tab"  href="index.php?acao=<?php echo $item12 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="far fa-user mr-1"></i>Cadastro Horarios</a>

					<a class="nav-link <?php echo $item11ativo ?>" id="v-pills-messages-tab"  href="index.php?acao=<?php echo $item11 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="far fa-user mr-1"></i>Cadastro Laboratorio</a>
				...
				<div class="tab-content" id="v-pills-tabContent">
					...
					<div class="tab-pane fade show active"  role="tabpanel">
						<?php if(@$_GET['acao'] == $item1){
							...
							$pag = 'externa';
							include_once("../painel-atend/".$item8.".php"); 
						}elseif(@$_GET['acao'] == $item9){
